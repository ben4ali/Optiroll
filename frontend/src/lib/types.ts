...
export const INSTRUMENT_CATEGORIES: {
...
}[] = [
  {
    ...
    instruments: [
      ...
      { label: 'Clavinet', value: 'clavinet', type: 'soundfont', sfName: 'clavinet' },
      { label: 'Harpsichord', value: 'harpsichord', type: 'soundfont', sfName: 'harpsichord' },
      ...
      { label: 'Electric Piano 1', value: 'electric_piano_1', type: 'soundfont', sfName: 'electric_piano_1' },
      { label: 'Electric Piano 2', value: 'electric_piano_2', type: 'soundfont', sfName: 'electric_piano_2' },
    ],
  },
  {
    label: 'Guitar',
    instruments: [
      { label: 'Acoustic Nylon', value: 'acoustic_guitar_nylon', type: 'soundfont', sfName: 'acoustic_guitar_nylon' },
      { label: 'Acoustic Steel', value: 'acoustic_guitar_steel', type: 'soundfont', sfName: 'acoustic_guitar_steel' },
      { label: 'Electric Clean', value: 'electric_guitar_clean', type: 'soundfont', sfName: 'electric_guitar_clean' },
      { label: 'Electric Jazz', value: 'electric_guitar_jazz', type: 'soundfont', sfName: 'electric_guitar_jazz' },
    ],
  },
  {
    ...
    instruments: [
      ...
      { label: 'Kalimba', value: 'kalimba', type: 'soundfont', sfName: 'kalimba' },
      { label: 'Dulcimer', value: 'dulcimer', type: 'soundfont', sfName: 'dulcimer' },
    ],
  },
  {
    label: 'Organ',
  ...
  },
  {
    ...
    instruments: [
      ...
      { label: 'Contrabass', value: 'contrabass', type: 'soundfont', sfName: 'contrabass' },
      { label: 'String Ensemble', value: 'string_ensemble_1', type: 'soundfont', sfName: 'string_ensemble_1' },
      { label: 'Pizzicato Strings', value: 'pizzicato_strings', type: 'soundfont', sfName: 'pizzicato_strings' },
      { label: 'Tremolo Strings', value: 'tremolo_strings', type: 'soundfont', sfName: 'tremolo_strings' },
  ...
  },
  {
    label: 'Synth',
    instruments: [
      { label: 'Pad Warm', value: 'pad_2_warm', type: 'soundfont', sfName: 'pad_2_warm' },
      { label: 'Pad Choir', value: 'pad_4_choir', type: 'soundfont', sfName: 'pad_4_choir' },
      { label: 'Lead Square', value: 'lead_1_square', type: 'soundfont', sfName: 'lead_1_square' },
      { label: 'Lead Sawtooth', value: 'lead_2_sawtooth', type: 'soundfont', sfName: 'lead_2_sawtooth' },
      { label: 'Synth Strings', value: 'synth_strings_1', type: 'soundfont', sfName: 'synth_strings_1' },
    ],
  },
  {
    label: 'Mellotron',
  ...
  },
  {
    label: 'Choir / Voice',
    instruments: [
      { label: 'Choir Aahs', value: 'choir_aahs', type: 'soundfont', sfName: 'choir_aahs' },
      { label: 'Voice Oohs', value: 'voice_oohs', type: 'soundfont', sfName: 'voice_oohs' },
      { label: 'Synth Voice', value: 'synth_voice', type: 'soundfont', sfName: 'synth_voice' },
      { label: 'Pad Choir', value: 'pad_4_choir_2', type: 'soundfont', sfName: 'pad_4_choir' },
      { label: 'Mellotron 8-Voice Choir', value: 'mello_choir_2', type: 'mellotron', mellotronName: '8VOICE CHOIR' },
      { label: 'Mellotron MK2 Brass', value: 'mello_brass', type: 'mellotron', mellotronName: 'MKII BRASS' },
    ],
  },
  {
    label: 'Brass',
    instruments: [
      ...
      { label: 'Trombone', value: 'trombone', type: 'soundfont', sfName: 'trombone' },
      { label: 'French Horn', value: 'french_horn', type: 'soundfont', sfName: 'french_horn' },
      { label: 'Tuba', value: 'tuba', type: 'soundfont', sfName: 'tuba' },
      { label: 'Brass Section', value: 'brass_section', type: 'soundfont', sfName: 'brass_section' },
    ],
  },
  {
    label: 'Woodwinds',
    instruments: [
      ...
      { label: 'Piccolo', value: 'piccolo', type: 'soundfont', sfName: 'piccolo' },
      { label: 'Clarinet', value: 'clarinet', type: 'soundfont', sfName: 'clarinet' },
      { label: 'Oboe', value: 'oboe', type: 'soundfont', sfName: 'oboe' },
      { label: 'Bassoon', value: 'bassoon', type: 'soundfont', sfName: 'bassoon' },
      { label: 'Alto Sax', value: 'alto_sax', type: 'soundfont', sfName: 'alto_sax' },
      { label: 'Soprano Sax', value: 'soprano_sax', type: 'soundfont', sfName: 'soprano_sax' },
      { label: 'Tenor Sax', value: 'tenor_sax', type: 'soundfont', sfName: 'tenor_sax' },
    ],
  },
];
